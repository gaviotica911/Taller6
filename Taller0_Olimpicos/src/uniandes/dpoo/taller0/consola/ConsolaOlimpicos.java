...
public class ConsolaOlimpicos
{
	...
	{
	String nombre= input("Digite el atleta que desea consultar");
    String respuesta =calculadora.modificacion(nombre);
    if(respuesta != null) {
    	System.out.println("El atleta "+nombre+" representa al país "+respuesta );
    }
    else
	{
    	System.out.println("No se encontro dicho atleta.");
	}
	}
